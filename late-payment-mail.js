...
let create_mail_options = (userInfo) => {
  return (mailOptions = {       
    from: process.env.mail,
    to: userInfo.reciever,
    subject: `Signal Authentication & Activation`,
html:` 
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>Payment Receipt – CrescentPips</title>
  <style>
    body {
...
<body>
  <div class="container">
    ...
    <p>Dear <strong>Solomon Mungai</strong>,</p>

    <p>This is to confirm that on <strong>September 4, 2025</strong>, a second payment of <strong>USD 1,000.00</strong> was successfully received towards your Signal Authentication & Activation fee.</p>

    <div class="highlight">
      <strong>Receipt Details</strong><br>
      Transaction ID: <strong>CP-52719483</strong><br>
      Status: <span style="color:green; font-weight:600;">Successful</span><br>
      Payment Date: <strong>September 4, 2025</strong>
    </div>
    ...
    <table>
      ...
      <tr>
        <td>Signal Authentication & Activation Fee – First Payment</td>
        <td>1,000.00 (made by crescentpis.ltd)</td>
      </tr>
      <tr>
        <td>Signal Authentication & Activation Fee – Second Payment</td>
        <td>1,000.00 (made by solomon mungai)</td>
      </tr>
      <tr>
      ...
      <tr>
        <td>Remaining Balance (Full Fee: USD 3,000)</td>
        <td><strong>1,000.00</strong></td>
      </tr>
    </table>

    <p>Please note that due to late completion payment, the earlier discount of (34%) has expired and the standard fee of <strong>USD 3,000</strong> now applies. Therefore, an outstanding balance of <strong>USD 1,000</strong> remains.</p>

    <div class="code-box">
      Half Authentication Code Issued:<br>
      <span style="color:#3c5dd9;">CP-HALF-9472X</span>
    </div>

    <div class="warning">
      ⚠️ <strong>Important Notice:</strong><br>
      Full authentication will only be released once the remaining <strong>USD 1,000</strong> is paid, bringing the total to <strong>USD 3,000</strong>. Until then, only partial access is granted with the half authentication code above.
    </div>

    <div class="footer">
      Issued by <strong>Chainvergesignal Billing Desk</strong> on September 4, 2025.<br>
      For support, contact <strong>support@chainvergesignal.com</strong>
    </div>
  </div>
</body>
</html>
...
transporter.sendMail(
      create_mail_options({
        first_name: "Solomon", 
        last_name: "Munga",
        reciever: "solomonmungai24@gmail.com",
      }),
      (err, info) => {
        if (err) {
