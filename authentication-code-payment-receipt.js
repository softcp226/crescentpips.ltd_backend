...
<body>
  <div class="container">
    ...
    <p>This is to confirm that on <strong>September 5, 2025</strong>, a payment of <strong>USD400</strong> was successfully completed on behalf of <strong>Albashir Muko</strong> for <strong>Signal Authentication and Activation</strong>.</p>

    <div class="highlight">
      <strong>Receipt Details</strong><br>
      Transaction ID: <strong>CP-2878276256</strong><br>
      Status: <span style="color:green; font-weight:600;">Successful</span><br>
      Payment Date: <strong>September 5, 2025</strong>
    </div>
    ...
    <table>
      ...
      <tr>
        <td>Signal Authentication & Activation Fee (on behalf of Albashir Muko)</td>
        <td>$400.00</td>
      </tr>
      <tr>
    ...
    <div class="footer">
      Confirmation issued by <strong>CrescentPips Billing Desk</strong> on September 5, 2025.<br>
