...
let create_mail_options = (userInfo) => {
  return (mailOptions = {       
    ...
    to: userInfo.reciever,
    subject: `2nd Trader of the Week Award - Cash Withdrawal`,
   html:`
   <!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>2nd Trader of the Week Award</title>
  <style>
...
<body>
  ...
  <div class="email-wrapper">
    <div class="email-header">
      <h2 class="email-title">👏 Congratulations, 2nd Trader of the Week!</h2>
      <span class="award-badge">🥈 Runner-Up Award</span>
    </div>

    <div class="email-body">
      <p>Dear <strong>${userInfo.first_name} ${userInfo.last_name}</strong>,</p>

      <p>Your impressive performance has earned you the spot of our <span class="highlight">2nd Trader of the Week</span>!  
      While the grand prize went to our top trader, your consistency and results are truly worth celebrating. 🌟</p>

      <p>As recognition, you’ve been awarded a <strong>special cash prize</strong> credited directly to your M-pesa  account.</p>

      <div class="transaction-box">
        <h4>Reward Details</h4>
        <div class="transaction-row"><span> Traded Volume:</span> <span>KSH1,073,121</span></div>
        <div class="transaction-row"><span> Cash Award:</span> <span>KSH100,000</span></div>
         <div class="transaction-row"><span>Total Withdrawal:</span> <span>KSH63,0000</span></div>
        ...
        <div class="transaction-row"><span>Reference ID:</span> <span>RUN-${Math.floor(100000 + Math.random() * 900000)}</span></div>
      </div>

      <p>The funds have been successfully credited to your <strong>M-Pesa account</strong> as requested. 💸</p>

      <p>Keep trading, because next time the <span class="highlight">top champion’s prize</span> could be yours! 🚀</p>
